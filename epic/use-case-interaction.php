...
<head>
	<meta charset="UTF-8">
	<title>Twitch Use Case</title>
</head>
<body>
<h1 class> Twitch Use Case:</h1>

<p><strong>Title:</strong>Subscribing to loltyler1's channel on Twitch.</p>

<p><strong>Description:</strong>Leeroy would like to become a sub to loltyler1 on Twitch.</p>

<p><strong>Name of User and their role:</strong>Leeroy, gaming enthusiast who loves to watch his favorite streamers play on Twitch.</p>

<p><strong>Usage preconditions:</strong>Must have Twitch account and it be linked to a credit card or Amazon Prime account.</p>

<p><strong>Usage postconditons:</strong>Subscribing to loltyler1's channel and become a sub being able to use channel emotes.</p>

<p><strong>Interaction flow:</strong>Subscribing to loltyler1's channel on Twitch.</p>
